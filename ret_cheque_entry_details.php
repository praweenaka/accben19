...
<table width="100%" border="0"  class=\"form-matrix-table\">
  ...
  <input type="text" disabled="disabled"  class="text_purchase2" id="txtcusname" name="txtcusname" />
    ...
    <a href="search_ledger_acc.php?stname=cash_pay" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()">
          <input type="button" name="additem_tmp2" id="additem_tmp2" value="..." class="btn_purchase1" />
        </a></font></font></td>
    <td colspan="2"><input type="text"  class="text_purchase3" size="10" id="acc_name" name="acc_name" onkeypress="keyset('bank',event);" /></td>
  </tr>
  </table>
