...
$newstrin = "Being Payment of Tyre Target Incentive for the Month of   7/2016  VIRHAN TYRE SERVICE Amount of 147,557.53 Checked by malaka";
$newtext = wordwrap($newstrin, 8, "\n", false);
...
<table width="1184" border="0">
  ...
  $longString = trim($row_rsPrInv1["l_lmem"]);
  $newtext= wordwrap($longString, 8, "\n", true);
  ...
  <tr>
    <td height="80" colspan="5" rowspan="11" align="left" valign="top"><p><?php echo $newtext; ?></p></td>
