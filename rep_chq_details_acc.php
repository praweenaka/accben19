...
<form name="form1" id="form1">            
  ...
  <tr>
    <td><input type="radio" name="radio" id="opdatewise" value="opdatewise" checked="checked" />Date Wise</td>
  ...
  <tr>
    <td><input type="radio" name="radio" id="op_bankwise" value="op_bankwise" />Bank Wise</td>
    <td colspan="3">&nbsp;</td>
    <td colspan="2">&nbsp;</td>
