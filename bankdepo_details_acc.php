...
<fieldset>
                                                	<legend>
  <div class="text_forheader">Bank Deposits Details</div>
                                               	 </legend>
<form name="form1" id="form1">            
  <table width="100%" border="0"  class=\"form-matrix-table\">
  <tr>
    <td width="10%"><input type="hidden" name="hiddencount" id="hiddencount" /></td>
    <td width="10%"><input type="hidden" name="chkprint" id="chkprint" value="0" /></td>
    <td width="10%"><input type="hidden" name="edit" id="edit" value="0" /></td>
    <td width="10%"><input type="hidden" name="new1" id="new1" value="0" /></td>
    <td width="10%">&nbsp;</td>
    <td width="10%">&nbsp;</td>
    <td width="10%">&nbsp;</td>
    <td width="10%">&nbsp;</td>
  ...
  <tr>
    ...
    <td><a href="serach_bank_depo_acc.php?stname=bank_depo" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()">
  ...
  <tr>
    ...
    <td colspan="7"><font color="#FFFFFF"><font color="#FFFFFF">
      <textarea name="TXT_HEADING" id="TXT_HEADING" cols="100" rows="5"></textarea>
    </font></font></td>
    <td><div id="cancel"></div></td>
  </tr>
  <tr>
      ...
      <tr>
        <td><font color="#FFFFFF">
          <div id="test"><font color="#FFFFFF">
            <input type="text"  class="text_purchase3" name="accno1" id="accno1" size="10" onkeypress="keyset('amt1',event);"  onblur="ledgno_ind('bankdepo_ent1');"   />
          </font></div>
        </font></td>
        <td><font color="#FFFFFF">
        ...
        <td><font color="#FFFFFF"><a href="search_ledger_acc.php?stname=bankdepo_ent1" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()">
...
<fieldset>               
  ...
  <tr>
      ...
      <tr>
        <td><font color="#FFFFFF">
          <div id="test"><font color="#FFFFFF">
          <input type="text"  class="text_purchase3" name="chqno" id="chqno" size="10" onkeypress="keyset('chqdate',event);"  onblur="chqno_inf('bankdepo');"    />
          </font></div>
        </font></td>
        <td><font color="#FFFFFF">
        ...
        <td><font color="#FFFFFF">
        <input type="text" size="15" name="chqamt" id="chqamt" value="" class="text_purchase3" onkeypress="keyset('additem_tmp1',event);"/>
...
<fieldset>               
  ...
  <tr>
        <td width="17%"><span class="style1">
        <input type="hidden"  class="label_purchase" value="Account No" disabled="disabled"/>
        </span></td>
        <td  width="17%"><span class="style1">
        <input type="hidden"  class="label_purchase" value="Account Name" disabled="disabled"/>
        </span></td>
        <td  width="32%"><span class="style1">
        <input type="hidden"  class="label_purchase" value="Description" disabled="disabled"/>
        </span></td>
        <td  width="6%">&nbsp;</td>
        <td  width="19%"><span class="style1">
        <input type="hidden"  class="label_purchase" value="Amount" disabled="disabled"/>
        </span></td>
    </tr>
      <tr>
        <td><font color="#FFFFFF">
          <div id="test"><font color="#FFFFFF">
          <input type="hidden"  class="text_purchase3" name="accno2" id="accno2" size="10" onkeypress="keyset('chqdate',event);"     />
          </font></div>
        </font></td>
        <td><font color="#FFFFFF">
        <input type="hidden"  class="text_purchase3" size="10" id="acc_name2" name="acc_name2" onkeypress="keyset('bank',event);" />
        
       
          </font></td>
        <td><font color="#FFFFFF">
        <input type="hidden" size="15" name="descript2" id="descript2" value="" class="text_purchase3" />
        ...
        <td><font color="#FFFFFF"><a href="search_ledger_acc.php?stname=journal_ent2" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()">
          <input type="hidden" name="additem_tmp2" id="additem_tmp2" value="..." class="btn_purchase1" />
        </a></font></td>
        <td><font color="#FFFFFF">
        <input type="hidden" size="15" name="amt2" id="amt2" value="" class="text_purchase3" onkeypress="keyset('additem_tmp2',event);"/>
        </font></td>
        
      
        <td width="5%"><input type="hidden" name="additem_tmp2" id="additem_tmp2" value="Add" onClick="addchq_cash_rec3();" class="btn_purchase1" /></td>
    </tr>
      <tr>
...
<table width="921" border="0">
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><input type="hidden" size="20" name="txtcash" id="txtcash" value="" disabled="disabled" class="text_purchase3"/></td>
  </tr>
  <tr>
    <td width="144">&nbsp;</td>
    <td width="127">&nbsp;</td>
