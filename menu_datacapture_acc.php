...
<div id="menus_wrapper">
    ...
    <div id="sec_menu">
        <ul>
            ...
            $result = $db->RunQuery($sql);
            if ($row = mysql_fetch_array($result)) {
                echo "<li><a href=\"cheque_setup_acc.php\" target=\"_blank\" class=\"sm2\" >Cheque Setup</a></li>";
            }
            ...
            $result = $db->RunQuery($sql);
            if ($row = mysql_fetch_array($result)) {
                echo "<li><a href=\"new\home.php?url=inv_ent\" target=\"_blank\" class=\"sm7\">Edit Inv Entry</a></li>";
                echo "<li><a href=\"new\home.php?url=pay_dbt\" target=\"_blank\" class=\"sm7\">Edit Pay Debit</a></li>";
            }
            ?>
        </ul>
    </div>
