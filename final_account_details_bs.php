        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0"  class="CSSTableGenerator">
            ...
            while ($i < 50) {
                ...
                while ($j < 6) {
                    ...
                    $sql = "select * from acc_cel_cal_bs where mrow=" . $i . " and mcol=" . $j . " and cell_type='text'";
                    $result = mysql_query($sql, $dbacc);
                    if ($row = mysql_fetch_array($result)) {
                        $cell_content = $row["description"];
                    }

                    $sql = "select * from acc_cel_cal_bs where mrow=" . $i . " and mcol=" . $j . " and cell_type='acc'";
                    $result = mysql_query($sql, $dbacc);
                    if ($row = mysql_fetch_array($result)) {
                        $sql1 = "select * from acc_account_data_bs where mrow=" . $i . " and mcol=" . $j . " ";
                    ...
                    $sql = "select * from acc_cel_cal_bs where mrow=" . $i . " and mcol=" . $j . " and cell_type='opr'";
                    $result = mysql_query($sql, $dbacc);
                    if ($row = mysql_fetch_array($result)) {
                        if (trim($row["opr"]) == "+") {
