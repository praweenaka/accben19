...
<fieldset>
                                                	<legend>
  <div class="text_forheader">Bank Reconciliation</div>
                                               	 </legend>             

<form name="form1" id="form1">            
  <table width="100%" border="0"  class=\"form-matrix-table\">
  <tr>
    <td width="14%"><input type="text"  class="label_purchase" value="Reconciliation Date" disabled/></td>
    <td width="14%"><input type="text" class="text_purchase3" name="dtpDate" id="dtpDate" onfocus="load_calader('dtpDate')"  value="<?php echo date("Y-m-d"); ?>" onchange="lastmonthcal();"/>      </td>
    <td width="2%">&nbsp;</td>
...
<!-- Tab 2  -->
       ...
       <div id="flexCre" class="CSSTableGenerator"> <table width="625" border="1" cellspacing="0">
        <tr>
          <td background="images/headingbg.gif" height="25">Ref No</td>
          <td background="images/headingbg.gif">Date</td>
          <td background="images/headingbg.gif">Cheque No</td>
  ...
  <tr>
    ...
    <fieldset><legend>Summerized Bank Account</legend>
        ...
        <table border="0">
          <tr>
            <th scope="col">&nbsp;</th>
            <th scope="col"><input type="text"  class="label_purchase" value="According to Ledger" disabled="disabled"/></th>
            <th scope="col"><input type="text"  class="label_purchase" value="According to Last Rec" disabled="disabled"/></th>
          </tr>
          <tr>
            ...
            <th width="179" scope="col"><input type="text" class="text_purchase3" align="right" name="txt_bankbal2" id="txt_bankbal2"  onkeypress="keyset('gr_status',event);"/></th>
          ...
          <tr>
            ...
            <td><input type="text" class="text_purchase3" name="txtbankdepo2" id="txtbankdepo2" align="right"  onkeypress="keyset('gr_status',event);"/></td>
          ...
          <tr>
            ...
            <td><input type="text" class="text_purchase3" name="txtbankpay2" id="txtbankpay2"  align="right" onkeypress="keyset('gr_status',event);"/></td>
          ...
          <tr>
            ...
            <td><input type="text" class="text_purchase3" name="txtclosebal2" id="txtclosebal2"  align="right" onkeypress="keyset('gr_status',event);"/></td>
