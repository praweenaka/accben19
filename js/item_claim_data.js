...
function calc_rem()
{
	if ((document.getElementById('txtremin1').value  != "") || (document.getElementById('txtremin2').value != "") || (document.getElementById('txtremin3').value != "") || (document.getElementById('txtremin4').value != "") || (document.getElementById('txtremin5').value != "")) {
		
    	var totremain = parseFloat(document.getElementById('txtremin1').value) + parseFloat(document.getElementById('txtremin2').value) + parseFloat(document.getElementById('txtremin3').value) + parseFloat(document.getElementById('txtremin4').value) + parseFloat(document.getElementById('txtremin5').value);
    	var totorigin = parseFloat(document.getElementById('txtorigin1').value) + parseFloat(document.getElementById('txtorigin2').value) + parseFloat(document.getElementById('txtorigin3').value) + parseFloat(document.getElementById('txtorigin4').value) + parseFloat(document.getElementById('txtorigin5').value);
