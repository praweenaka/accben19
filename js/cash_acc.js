...
function setamt(accno, i)
{
	xmlHttp=GetXmlHttpObject();
			...
			url=url+"&txt_entno="+document.getElementById('Txtrecno').value;
			url=url+"&accno="+accno;
...
function setamt_result11()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		document.getElementById("Txtchtot").value=xmlHttp.responseText;
		if (document.getElementById('Txtchtot').value==""){
			document.getElementById('Txtchtot').value=0;
		}
		
		if (document.getElementById('txtcash').value==""){
			document.getElementById('txtcash').value=0;
		}
		document.getElementById("txtpaytot").value=document.getElementById("Txtchtot").value+document.getElementById("txtcash").value;
...
function save_crec()
{
	xmlHttp=GetXmlHttpObject();
			...
			url=url+"&txtnaration="+document.getElementById('txtnaration').value;
...
//		document.getElementById('invno1').value = XMLAddress1[0].childNodes[0].nodeValue;
	//	alert(XMLAddress1[0].childNodes[0].nodeValue);
		...
		opener.document.form1.txtnaration.value = XMLAddress1[0].childNodes[0].nodeValue;
