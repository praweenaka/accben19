...
{   
			...
			if (stname=="cheque_pay_smp"){
				var url="search_ledger_data_acc.php";			
				url=url+"?Command="+"pass_cash_rec";
				url=url+"&ledgno="+custno;
							
				//alert(url);
				xmlHttp.onreadystatechange=passcusresult_cheque_pay_smp;
			}
...
function passcusresult_cheque_pay_smp()
{
	var XMLAddress1;
...
//		alert(xmlHttp.responseText);
                ...
                opener.document.getElementById("itemPrice").focus();
