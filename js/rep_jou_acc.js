...
function ini(){
	document.getElementById('txtchqno').style.visibility="hidden";
	document.getElementById('chqno').style.visibility="hidden";
...
function show_ledger()
{
	var url;
		...
		url="report_jou_schedule.php";
	
	url=url+"?optrefno="+document.getElementById('optrefno').checked;
	url=url+"&optdate="+document.getElementById('optdate').checked;
	url=url+"&optjou="+document.getElementById('optjou').checked;
	url=url+"&optbanktrans="+document.getElementById('optbanktrans').checked;
	url=url+"&optbankdepo="+document.getElementById('optbankdepo').checked;
	url=url+"&optchqpay="+document.getElementById('optchqpay').checked;
	url=url+"&repdatefrom="+document.getElementById('repdatefrom').value;
	url=url+"&repdateto="+document.getElementById('repdateto').value;
...
{   
			...
			document.getElementById('sep').value="0";
			document.getElementById('oct').value="0";
			document.getElementById('nov').value="0";
...
function save_crec()
{
	xmlHttp=GetXmlHttpObject();
			...
			var level;
			if (document.getElementById('acc_type1').checked==true){
				level="E";	
			} if (document.getElementById('acc_type2').checked==true){
				level="P";		
			} if (document.getElementById('acc_type3').checked==true){
				level="D";		
			}
			
			url=url+"&level="+level;
			url=url+"&acc_type1="+document.getElementById('acc_type1').value;
			url=url+"&txtOpenBal1="+document.getElementById('txtOpenBal1').value;
