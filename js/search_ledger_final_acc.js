...
{   
			...
			} else if (stname=="journal"){
				
				var url="search_ledger_data_acc.php";
				url=url+"?Command="+"search_journal";
				
			}  else if (stname=="ledger_sel"){
				var url="search_ledger_data_acc.php";
				url=url+"?Command="+"search_ledger_sel";
				
			}  else if (stname=="ledger"){
				
				var url="search_ledger_data_acc.php";
				url=url+"?Command="+"search_ledger";
...
{   
			...
			if (stname=="cheque_pay1"){
				
				str=custno;
				var txt_custno=str.replace(/&/g,"~");
				
				var url="search_chq_data_acc.php";			
				url=url+"?Command="+"pass_chqno_vat_barer1";
				url=url+"&custno="+txt_custno;
				
				xmlHttp.onreadystatechange=passcusresult_pass_chqno_vat_barer1;
			}
			
			if (stname=="cheque_pay2"){
				...
				xmlHttp.onreadystatechange=passcusresult_pass_chqno_vat_barer2;
			}
			
			if (stname=="cheque_pay3"){
				...
				xmlHttp.onreadystatechange=passcusresult_pass_chqno_vat_barer3;
			}
...
function passcusresult_pass_chqno_vat_barer()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		window.opener.document.getElementById('txtVATNO').value=XMLAddress1[0].childNodes[0].nodeValue;
...
function passcusresult_pass_chqno_vat_barer1()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		window.opener.document.getElementById('txt_bea1').value=XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("vatno");	
		window.opener.document.getElementById('txtVATNO1').value=XMLAddress1[0].childNodes[0].nodeValue;
...
function passcusresult_pass_chqno_vat_barer2()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("bea1");	
		window.opener.document.getElementById('txt_bea2').value=XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("vatno");	
		window.opener.document.getElementById('txtVATNO2').value=XMLAddress1[0].childNodes[0].nodeValue;
...
function passcusresult_pass_chqno_vat_barer3()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("bea1");	
		window.opener.document.getElementById('txt_bea3').value=XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("vatno");	
		window.opener.document.getElementById('txtVATNO3').value=XMLAddress1[0].childNodes[0].nodeValue;
...
function passcusresult_journal_cre_deb()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		opener.document.form1.TXT_DETAILS.value=myString;
...
try{
		//	alert(stname);
			...
			if ((stname=="final_acc") || (stname=="final_acc1")){
				var url="search_ledger_final_data_acc.php";			
				url=url+"?Command="+"final_acc";
				url=url+"&ledgno="+custno;
                                url=url+"&stname="+stname;
				alert(opener.document.form1.opr_acc.value);
				if (opener.document.form1.opr_acc.value=="+"){
					url=url+"&opr_acc=~";
				} else {
					url=url+"&opr_acc=-";	
				}
...
function passcusresult_final_acc()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		window.opener.document.getElementById('acc_table').innerHTML=XMLAddress1[0].childNodes[0].nodeValue;
...
function passcusresult_journal_ent2()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		opener.document.form1.amt2.focus();
...
function passcusresult_vat_schedule()
{
	var XMLAddress1;
...
function passcusresult_ledger_sel()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("bm_chno");	
		opener.document.form1.chqno.value=XMLAddress1[0].childNodes[0].nodeValue; 
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("c_opbal1");	
		opener.document.form1.txtOpenBal1.value=XMLAddress1[0].childNodes[0].nodeValue; 
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("comments");	
		opener.document.form1.textcomments.value=XMLAddress1[0].childNodes[0].nodeValue; 
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("c_date");	
		if ((XMLAddress1[0].childNodes[0].nodeValue!="") && (XMLAddress1[0].childNodes[0].nodeValue!="0000-00-00")){
		...
		if (c_type=="B"){
			...
			opener.document.form1.op_manu.checked	= true;	
		} else if (c_type=="P"){
			opener.document.form1.optPLAcc.checked	= true;	
		}
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("c_group");	
		var c_group=XMLAddress1[0].childNodes[0].nodeValue;
		if (c_group=="E"){
			opener.document.form1.acc_type1.checked = true;
		} else if (c_group=="P"){
			opener.document.form1.acc_type2.checked = true;
		} else if (c_group=="D"){
			opener.document.form1.acc_type3.checked = true;
		}
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("cat");	
		var cat=XMLAddress1[0].childNodes[0].nodeValue;
		...
		if (cat=="C"){
			...
			opener.document.form1.txtchqno.style.visibility="hidden";
			opener.document.form1.chqno.style.visibility="hidden";
			
		} else if (cat=="B"){
			opener.document.form1.Check1.checked = false;
			opener.document.form1.Check2.checked = true;
			opener.document.form1.txtchqno.style.visibility="visible";
			opener.document.form1.chqno.style.visibility="visible";
		} else {
			opener.document.form1.Check1.checked = false;
			opener.document.form1.Check2.checked = false;	
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("c_nod_add");	
