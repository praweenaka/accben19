...
function lastmonthcal_results()
{
	...
	//alert(xmlHttp.responseText);
		...
		{ 	
			...
			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txt_bF");	
			document.getElementById('txt_bankbal2').value = XMLAddress1[0].childNodes[0].nodeValue;	
...
function display()
{
	...
	url=url+"&txt_bankbal2="+document.getElementById('txt_bankbal2').value;
...
function display_results()
{
	var XMLAddress1;
		...
		{ 	
			...
			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtbankpay");	
			document.getElementById('txtbankpay2').value = XMLAddress1[0].childNodes[0].nodeValue;		
			
			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtbankdepo");	
			document.getElementById('txtbankdepo2').value = XMLAddress1[0].childNodes[0].nodeValue;	
			...
			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtclosebal2");	
			document.getElementById('txtclosebal2').value = XMLAddress1[0].childNodes[0].nodeValue;	
...
{   
			...
			var url="bank_recon_data.php";			
			url=url+"?Command="+"update_customer";
			url=url+"&txtBankCode="+document.getElementById('Com_CAS').value;
			url=url+"&dtpDate="+document.getElementById('dtpDate').value;
			...
			xmlHttp.onreadystatechange=update_customer_result;
			xmlHttp.open("GET",url,true);
			xmlHttp.send(null);
		
}

function update_customer_result()
{
	var XMLAddress1;
...
function print_recon()
{
			...
			url=url+"&txt_bankbal="+document.getElementById('txt_bankbal').value;
			url=url+"&txt_bankbal2="+document.getElementById('txt_bankbal2').value;
			url=url+"&txtclosebal2="+document.getElementById('txtclosebal2').value;
