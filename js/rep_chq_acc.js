...
function show_ledger()
{
	var url;
		...
		url="report_chq_schedule.php";
	
	url=url+"?opdatewise="+document.getElementById('opdatewise').checked;
	url=url+"&op_bankwise="+document.getElementById('op_bankwise').checked;
	//url=url+"&op_dtreport="+document.getElementById('op_dtreport').checked;
