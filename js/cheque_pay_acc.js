...
function pass_rec_result()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        opener.document.getElementById("itemCode").value = "";
        opener.document.getElementById("itemDesc").value = "";
        opener.document.getElementById("itemPrice").value = "";

        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("sales_table");
        window.opener.document.getElementById('itemdetails').innerHTML = XMLAddress1[0].childNodes[0].nodeValue;

        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("nara");
        window.opener.document.getElementById('qty').value = XMLAddress1[0].childNodes[0].nodeValue;
