...
<tr>
      ...
      <td width="603"  background="images/headingbg.gif" ><input type="text" size="70" name="customername" id="customername" value="" class="txtbox" onkeyup="<?php echo "update_cust_list('$stname')"; ?>"/></td>
                ...
                <div id="filt_table" class="CSSTableGenerator">  <table width="735" border="0" class=\"form-matrix-table\">
							...
							$sql="select cheque_no, che_amount, che_date, bank, refno, CUS_NAME, ID, ret_refno  from s_invcheq  ORDER BY che_date desc limit 50";
							//echo $sql;
							$stname = $_GET["stname"];
							...
							echo "<tr>               
							  ...
							  if (($row['ret_refno']!='1') and ($row['ret_refno']!='0')){	   
							  	echo "<td onclick=\"chqno('$cuscode', '$stname');\">".$row['ret_refno']."</td>";	
							  } else {
							  	echo "<td onclick=\"chqno('$cuscode', '$stname');\"></td>";
							  }	                             
                            echo "</tr>";
							}
							  ?>
