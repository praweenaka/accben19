...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <td><input type="text" size="20" name="txt_Date" id="txt_Date" value="<?php echo date("Y-m-d"); ?>" onfocus="load_calader('txt_Date');" class="text_purchase3"/></td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="7"><font color="#FFFFFF"><font color="#FFFFFF">
      <textarea name="TXT_DETAILS" id="TXT_DETAILS" cols="100" rows="5"></textarea>
    </font></font></td>
    <td>&nbsp;</td>
  </tr>
  </table>
      ...
      <tr>
        <td><font color="#FFFFFF">
          <div id="test"><font color="#FFFFFF">
            <input type="text"  class="text_purchase3" name="accno1" id="accno1" size="10" onkeypress="keyset('amt1',event);"  onblur="ledgno_ind('journal_ent1');"    />
          </font></div>
        </font></td>
        <td><font color="#FFFFFF">
...
<fieldset>               
  ...
  <tr>
      ...
      <tr>
        <td><font color="#FFFFFF">
          <div id="test"><font color="#FFFFFF">
            <input type="text"  class="text_purchase3" name="accno2" id="accno2" size="10" onkeypress="keyset('amt2',event);"  onblur="ledgno_ind('journal_ent2');"   />
          </font></div>
        </font></td>
        <td><font color="#FFFFFF">
