...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <td><input type="text" name="MonthView1" id="MonthView1" class="text_purchase3"/>
        <script type="text/javascript">
	window.onload = function(){
		new JsDatePick({
			useMode:2,
...
<fieldset>               
  ...
  <tr>
    <td colspan="8"><a onclick="NewWindow('serach_inv_crn.php?stname=cash_crn_form_cash','mywin','800','700','yes','center');return false" onfocus="this.blur()">
