...
if($_GET["Command"]=="save_item")
{
	...
	$sql_lcode="insert into ledger (l_refno, l_code, l_date, l_lmem, l_amount, l_flag, l_flag1, comcode, l_yearfl) values ('" . trim($_GET["lblReciptNo"]) . "', '" . trim($_GET["txtAccCode"]) . "', '" . $_GET["dtpOpenDate"] . "' , 'Openning Balance'," . abs($_GET["txtOpenBal"]) . "  , 'OPB', '" . $LedFlag . "' , '" . $_SESSION['company'] . "','0')";
