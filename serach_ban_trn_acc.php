...
<tr>					
	  				...
	  				$stname = $_GET["stname"];
					?>
                             <td width="279"  background="images/headingbg.gif" ><input type="text" size="20" name="recno" id="recno" value="" class="txtbox"  onkeyup="<?php echo "update_list('$stname')"; ?>"/></td>
    <td width="259"  background="images/headingbg.gif" ><input type="text" size="29" name="recdate" id="recdate" value="" class="txtbox"/></td>
    <td width="217"  background="images/headingbg.gif" ><input type="text" size="29" name="recamt" id="recamt" value="" class="txtbox"/></td>
    <td width="9"  background="images/headingbg.gif" >
    <td width="37"  background="images/headingbg.gif" >&nbsp;</td>
    <td width="130"></td>
...
<tr>
							...
							$sql="select *  from bankentmas where cancel!='1' ORDER BY bdate desc limit 50";
