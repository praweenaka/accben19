...
<tr>					
	  				...
	  				$stname = $_GET["stname"];
					?>
                             <td width="257"  background="images/headingbg.gif" ><input type="text" size="20" name="recno" id="recno" value="" class="txtbox"  onkeyup="<?php echo "update_list('$stname')"; ?>"/></td>
    <td width="194"  background="images/headingbg.gif" ><input type="text" size="29" name="chqno" id="chqno" value="" onkeyup="<?php echo "update_list('$stname')"; ?>" class="txtbox"/></td>
    <td width="195"  background="images/headingbg.gif" ><input type="text" size="29" name="recamt" id="recamt" value="" class="txtbox"/></td>
    <td width="54"  background="images/headingbg.gif" >
    <td width="94"  background="images/headingbg.gif" >&nbsp;</td>
    <td width="137"></td>
...
<tr>
							...
							$sql="select refno, bdate, cheno, name, amount from paymas where type='B'   ORDER BY refno desc limit 50";
							...
							echo "<tr>               
                              <td onclick=\"recno('".$row['refno']."','$stname');\">".$row['refno']."</a></td>
                              <td onclick=\"recno('".$row['refno']."','$stname');\">".date("Y-m-d", strtotime($row["bdate"]))."</a></td>
							  <td onclick=\"recno('".$row['refno']."','$stname');\">".$row["cheno"]."</a></td>
							   <td onclick=\"recno('".$row['refno']."','$stname');\">".$row["name"]."</a></td>
                              <td onclick=\"recno('".$row['refno']."','$stname');\">".$row['amount']."</a></td></tr>";
