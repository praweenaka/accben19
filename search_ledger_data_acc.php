...
//echo $res;
    ...
    if ($_GET["mstatus"] == "cusno") {
        $letters = $_GET['cusno'];
        //$letters = preg_replace("/[^a-z0-9 ]/si","",$letters);
        $sql = "select c_code,c_name from lcodes where c_group='D' and c_code like '$letters%' ORDER BY c_code limit 100";
    } else if ($_GET["mstatus"] == "customername") {
        $letters = $_GET['customername'];
        //$letters = preg_replace("/[^a-z0-9 ]/si","",$letters);
        $sql = "select c_code,c_name from lcodes where c_group='D' and c_name like '$letters%' ORDER BY c_code limit 100";
    } else {
    ...
    if ($_GET["stname"] == "final_acc" or $_GET["stname"] == "final_acc1") {
        if ($_GET["mstatus"] == "cusno") {
            $letters = $_GET['cusno'];
            //$letters = preg_replace("/[^a-z0-9 ]/si","",$letters);
