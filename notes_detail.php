...
<script type="text/javascript" language="JavaScript1.2" src="js/final_acc.js"></script>
            ...
            <tr>
                ...
                <td colspan='4'>
                    <select id="row" onclick="loadnt();" name="row">
                        <?php
                        $sql = "select * from acc_cel_cal where description like '(%'";
                        $result = $db->RunQuery($sql);
                        while ($row = mysql_fetch_array($result)) {
                            $sql = "select * from acc_cel_cal where mrow = '" . $row['mrow'] . "' and mcol = '2'";
