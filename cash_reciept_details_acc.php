...
<fieldset>
  ...
  <tr>
    ...
    <td colspan="2"><input type="text" disabled="disabled" name="Txtrecno" id="Txtrecno" value="" class="text_purchase3" onkeypress="keyset('searchcust',event);" onfocus="got_focus('invno');"  onblur="lost_focus('invno');"  />      <a href="serach_rec_acc.php?stname=cash_rec" onClick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onFocus="this.blur()"></a></td>
    <td width="2%"><a href="serach_rec_acc.php?stname=cash_rec" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()">
  ...
  <tr>
    ...
    <td><input type="text" size="20" name="txtDATE" id="txtDATE" value="<?php echo date("Y-m-d"); ?>"  onfocus="load_calader('txtDATE');" class="text_purchase3"/></td>
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><a href="search_ledger_acc.php?stname=cash_rec1" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()"></a></td>
  ...
  <tr>
    ...
    <td><a href="search_ledger_acc.php?stname=cash_rec2" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()"></a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><input type="text"  class="label_purchase" value="Narration" disabled="disabled"/></td>
    <td colspan="3"><textarea name="txtnaration" id="txtnaration" cols="70" rows="5"></textarea></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="2">
      <input type="text" class="text_purchase3" id="TXTAC_REF" name="TXTAC_REF" />    </td>
    <td width="1%">&nbsp;</td>
    <td width="19%"><input type="checkbox" name="chkbank" id="chkbank" />
      Bank</td>
    <td width="10%">&nbsp;</td>
    <td width="10%">&nbsp;</td>
    <td width="9%">&nbsp;</td>
