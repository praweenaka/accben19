 ...
 while ($rstemp = mysql_fetch_array($result_rst)){
 	...
 	if ($rstemp['TRN_TYPE']=="INV"){
 		...
 		$ResponseXML .= "<tr>                              
							 ...
							 <td><a href=\"\" onClick=\"NewWindow('sales_inv_display.php?refno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\"> ".number_format($rstemp['AMOUNT'], 2, ".", ",")."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('sales_inv_display.php?refno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\"> ".number_format($rstemp['BALANCE'], 2, ".", ",")."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('sales_inv_display.php?refno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\"> ".$rstemp['TRN_TYPE']."</a></td></tr>";
		
		} else if ($rstemp['TRN_TYPE']=="CNT"){
			...
			$ResponseXML .= "<tr>                              
							 ...
							 <td><a href=\"\" onClick=\"NewWindow('crn_display.php?crnno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".number_format($rstemp['AMOUNT'], 2, ".", ",")."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('crn_display.php?crnno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".number_format($rstemp['BALANCE'], 2, ".", ",")."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('crn_display.php?crnno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".$rstemp['TRN_TYPE']."</a></td></tr>";
							 
		} else if (($rstemp['TRN_TYPE']=="GRN") or ($rstemp['TRN_TYPE']=="DGRN")){
			...
			$ResponseXML .= "<tr>                              
							 ...
							 <td><a href=\"\" onClick=\"NewWindow('grn_display.php?grn=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".number_format($rstemp['BALANCE'], 2, ".", ",")."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('grn_display.php?grn=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".$rstemp['TRN_TYPE']."</a></td></tr>";
			...
			$ResponseXML .= "<tr>                              
							 ...
							 <td><a href=\"sales_inv_display.php?refno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."\">".$rstemp['TRN_TYPE']."</a></td></tr>";
