...
<table width="922" height="428" border="0">
  ...
  <tr>
    ...
    <td width="78"><span class="style2"><?php echo $row["C_CODE"]; ?></span></td>
    <td colspan="3"><span class="style2"><?php echo $row["CUS_NAME"]; ?></span></td>
    <td width="88">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="199" colspan="7"><table width="904" height="81" border="1" cellspacing="0">
      ...
      <?php 
	  	$sql1="Select * from tmp_inv_data where str_invno='".$_GET["invno"]."'";
    	$result1 =$db->RunQuery($sql1);	
