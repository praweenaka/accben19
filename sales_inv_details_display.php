...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <td><input type="text" disabled="disabled"  class="text_purchase2" id="department" name="department" value="<?php $row['DEPARTMENT']; ?>" /> </td>
  ...
  <tr>
    ...
    <td><input type="text" disabled="disabled"  class="text_purchase2" id="salesrep" name="salesrep" value="<?php echo $row['SAL_EX']; ?>" /></td>
...
<fieldset>               
				...
				while($row1 = mysql_fetch_array($sql_data)){
			 	...
			 	echo "<tr>
                            <td onClick=\"disp_qty('".$row1['STK_NO']."');\">".$row1['STK_NO']."</a></td>
							 ...
							 <td onClick=\"disp_qty('".$row1['STK_NO']."');\">".$row['QTY']."</a></td>
  ...
  <tr>
    ...
    <td><input type="text" size="15" name="subtot" id="subtot" value="<?php echo "123"; echo $row['AMOUNT']; ?>" disabled="disabled" class="text_purchase3"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><span class="style1">
