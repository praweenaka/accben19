...
<fieldset>
  ...
  <tr>
    <td><input type="hidden" name="hiddencount" id="hiddencount" /></td>
     <td width="14%"><input type="hidden" name="chkprint" id="chkprint" value="0" /></td>
  ...
  <tr>
    ...
    <td> <a href="serach_ban_trn_acc.php?stname=bank_trn" onClick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onFocus="this.blur()">
    ...
    <td><input type="text" size="20" name="dtpDate" id="dtpDate" value="<?php echo date("Y-m-d"); ?>" class="text_purchase3" onfocus="load_calader('dtpDate');"/></td>
  ...
  <tr>
    ...
    <td colspan="7">
    <textarea name="TXT_HEADING" id="TXT_HEADING" cols="100" rows="5"></textarea></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td width="14%" colspan="4"><select name="txtacccode" id="txtacccode" onkeypress="keyset('dte_dor',event);" onchange="setord();" class="text_purchase3">
        <option value=""></option>
        <?php
    ...
    <td width="14%">&nbsp;</td>
    <td width="14%"><input type="hidden" class="text_purchase3" id="com_bank" name="com_bank" /></td>
    <td width="9%">&nbsp;</td>
    <td width="7%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><input type="radio" name="radio" id="Option2" value="radio" checked="checked" />
Payment</td>
    <td>&nbsp;</td>
...
RTN</td>
  ...
  <tr>
    ...
    <td><input type="text"  class="text_purchase3"  id="DTinv_date" name="DTinv_date" onfocus="load_calader('DTinv_date')" /></td>
    ...
    <td colspan="2"><input type="checkbox" name="Check1" id="Check1" onclick="chkvat();" /></td>
    <td>&nbsp;</td>
  </tr>
  </table>
      ...
      <tr>
        <td><font color="#FFFFFF">
          <div id="test"><font color="#FFFFFF">
            <input type="text"  class="text_purchase3" name="accno" id="accno" size="10" onkeypress="keyset('amt',event);"  onblur="ledgno_ind('bank_trans_acc');"    />
          </font></div>
        </font></td>
        <td><font color="#FFFFFF">
        ...
        <td><font color="#FFFFFF"><a href="search_ledger_acc.php?stname=bank_trans_acc" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()">
