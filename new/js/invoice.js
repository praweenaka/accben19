...
function showarmyresultdel() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {
        ...
        document.getElementById('itemCode').value = "Z";
...
function save_inv() {
    ...
    if (document.getElementById('txt_entno').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Entry Not Selected</span></div>";
        return false;
    }

    if (document.getElementById('subtot').value != document.getElementById('nbt').value) {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Error In Debit Total</span></div>";
        return false;
    }
...
function update_list(stname) {
    ...
    url = url + "&refno1=" + document.getElementById('cusno1').value;
