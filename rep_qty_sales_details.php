...
<table width="787" border="0">
  <tr>
    ...
    <td width="169" align="left"><input type="text" size="20" name="DTfrom" id="DTfrom"  onfocus="load_calader('DTfrom');" class="text_purchase3" value="<?php echo date("Y-m-d"); ?>"/>    </td>
  ...
  <tr>
    ...
    <td align="left"><select name="cmbtype" id="cmbtype" class="text_purchase3" onchange="set_chk();">
